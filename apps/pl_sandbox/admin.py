...
class CommandResultAdmin(admin.ModelAdmin):
    """Admin interface for CommandResult."""
    
    list_display = ('id', 'response', 'exit_code', 'command')
...
class ResponseAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'request', 'status', 'total_time')
